...
public static partial class Noise
{
    ...
    public struct Simplex : IGradient
    {
        ...
        public float4 Evaluate(SmallXXHash4 hash, float4 x, float4 y, float4 z) =>
            BaseGradients.Sphere(hash, x, y, z) * (1024f / (125f * sqrt(3f)));  //the last bit of all these are the normalizations, check the tutorial on CatLikeCoding for the mathematical reasons on it
